                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="form-control @error('entryPermission') is-invalid @enderror" id="entryPermission" name="entryPermission" autofocus>
                                        ...
                                        @foreach ($entryUsers as $entryUser)
                                            <option @if(old('entryPermission') == $entryUser->email) selected @endif value="{{ $entryUser->email }}">{{$entryUser->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="form-control @error('workPermissionApproval') is-invalid @enderror" id="workPermissionApproval" name="workPermissionApproval" autofocus>
                                        ...
                                        @foreach ($workUsers as $workUser)
                                            <option @if(old('workPermissionApproval') == $workUser->email) selected @endif value="{{ $workUser->email }}">{{$workUser->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
