<style>
    input[readonly].transparentBackground{
...
<form method="POST" action="" id="FormTest" enctype="multipart/form-data">
    ...
    <div class="form-row">
        ...
        <div class="form-check form-check-inline">
            <input id="roadmap0" type="radio" class="form-check-input" name="roadmap" @if(old('roadmap') == 0) checked @else disabled @endif value="0" autofocus>
            <label class="form-check-label" for="roadmap0">@lang('main.yes')</label>
        </div>
        <div class="form-check form-check-inline">
            <input id="roadmap1" type="radio" class="form-check-input" name="roadmap" @if(old('roadmap') == 1) checked @else disabled @endif value="1" autofocus>
    ...
    <div class="form-row">
        ...
        <div class="form-check form-check-inline">
            <input id="hygieneRegulations1" type="radio" class="form-check-input" name="hygieneRegulations" @if(old('hygieneRegulations') == 1) checked @else disabled @endif value="1" autofocus>
            <label class="form-check-label" for="hygieneRegulations1">@lang('main.yes')</label>
        </div>
        <div class="form-check form-check-inline">
            <input id="hygieneRegulations0" type="radio" class="form-check-input" name="hygieneRegulations" @if(old('hygieneRegulations') == 0) checked @else disabled @endif value="0" autofocus>
    ...
    <div class="form-row">
        ...
        <div class="form-group col">
            <select readonly class="form-control transparentBackground @error('contactPossibility') is-invalid @enderror" id="contactPossibility" name="contactPossibility" autofocus>
                <option class="transparentBackground" @if(old('contactPossibility') == "E-Mail") selected @endif value="E-Mail">@lang('main.email')</option>
                <option class="transparentBackground" @if(old('contactPossibility') == "Telefon") selected @endif value="Telefon">@lang('main.phone')</option>
            </select>
