                            ...
                            @foreach($data as $items)
                                <tr id="{{ $items->id }}">
                                    ...
                                    <td class="text-right" nowrap="nowrap">
                                        ...
                                        @endif
                                        @if (Auth::user()->id == $items->userId || Auth::user()->role == "Admin" || Auth::user()->role == "Super Admin")
...
<script>
    ...
    function addvisitorElement(data , allocationid, parentId, visitId)
    {
        ...
        else
        {
            ...
            if(allocationid)
            {
                var input7 = $('<input>').attr("type", 'hidden').addClass('form-control').attr("name", "allocationid").val(allocationid);
    ...
    function addUserElement(data , allocationid, parentId, userId)
    {
        ...
        else
        {
            ...
            if(allocationid)
            {
                var input7 = $('<input>').attr("type", 'hidden').addClass('form-control').attr("name", "allocationUserid").val(allocationid);
                $("#allocation").append(input7);
            }
