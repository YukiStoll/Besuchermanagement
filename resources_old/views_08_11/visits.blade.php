                    ...
                    <div class="col">
                        ...
                        <div>
                            <div class="btn-group float-right">
                                <a class="btn @if($pagitems == 5)  btn-dark  @else btn-light @endif btn-sm" @if($pagitems == 5) @if(env("APP_table_Color")) style="background: {{ env("APP_table_Color") }}" @endif @endif href="{{ $data->appends(['items' => '5','von' => $requestData['startDate'],'bis' => $requestData['endDate'],'search' => $requestData['search'],])->url(1) }}">5</a>
                                <a class="btn @if($pagitems == 10)  btn-dark  @else btn-light @endif btn-sm" @if($pagitems == 10) @if(env("APP_table_Color")) style="background: {{ env("APP_table_Color") }}" @endif @endif href="{{ $data->appends(['items' => '10','von' => $requestData['startDate'],'bis' => $requestData['endDate'],'search' => $requestData['search'],])->url(1) }}">10</a>
                                <a class="btn @if($pagitems == 25)  btn-dark  @else btn-light @endif btn-sm" @if($pagitems == 25) @if(env("APP_table_Color")) style="background: {{ env("APP_table_Color") }}" @endif @endif href="{{ $data->appends(['items' => '25','von' => $requestData['startDate'],'bis' => $requestData['endDate'],'search' => $requestData['search'],])->url(1) }}">25</a>
                                <a class="btn @if($pagitems == 50)  btn-dark  @else btn-light @endif btn-sm" @if($pagitems == 50) @if(env("APP_table_Color")) style="background: {{ env("APP_table_Color") }}" @endif @endif href="{{ $data->appends(['items' => '50','von' => $requestData['startDate'],'bis' => $requestData['endDate'],'search' => $requestData['search'],])->url(1) }}">50</a>
                            </div>
                            {{ $data->appends(
                            [
                                'items' => $pagitems,
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                ...
                                <div hidden id="div-phone-number">
                                    <div class="form-row">
                                        <div class="form-group col">
                                            <label class="form-inline">@lang('main.pleaseCallTheEmployee')</label>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col">
    ...
    function submitSpontaneousVisitForm()
        ...
        function finishVisit(id) {
            ...
            $.ajax({
                ...
                dataType:"json",
                data: {
                    deleted_at:"{{ Illuminate\Support\Carbon::createFromDate() }}",
        ...
        {
            const divPhoneNumber = $('#div-phone-number');
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    if(data['contactPossibility'] == 'Telefon')
                    {
                        divPhoneNumber.removeAttr('hidden');
                        if(data['employee']['telephone_number'] != null && data['employee']['telephone_number'] != 'undefined' && data['employee']['telephone_number'] != '')
                        {
                            $('#phone-number').val(data['employee']['telephone_number']);
                        }
                        else
                        {
                            $('#phone-number').val(data['employee']['mobile_number']);
                        }
                    }
                    ...
                    if(data['entryPermission'] != null)
                    {
                        var entryPermission = $("<input>").attr('class', "form-control text-center text-primary font-weight-bold").attr('style', 'background: white !important; opacity: 100 !important;').attr('disabled', '').attr("id", "entryPermission").val('@lang('main.entryPermitHasBeenGranted')');
        ...
        function addvisitorElement(data, visitId)
        {
                ...
                $("#form-row" + counter).append(div1, div2, div3, div5, div4);
